...
class ViTLightningModule(pl.LightningModule):
    def __init__(self, num_labels=2):
        ...
        self.swin = AutoModelForImageClassification.from_pretrained(model_name,
...
# model = ViTLightningModule().load_from_checkpoint('./lightning_logs/lightning_logs/version_18/checkpoints/epoch=44-step=4905.ckpt')
# model.eval()
#
...
# pred_df.to_csv('submission_swin_b_1.csv')
