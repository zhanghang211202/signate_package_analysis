...
checkpoint_callback = ModelCheckpoint(save_top_k=1, monitor="validation_accuracy")
...
# model = ViTLightningModule().load_from_checkpoint('./lightning_logs/lightning_logs/version_10/checkpoints/epoch=33-step=12954.ckpt')
# model.eval()
#
...
# pred_df.to_csv('submission_3.csv')
